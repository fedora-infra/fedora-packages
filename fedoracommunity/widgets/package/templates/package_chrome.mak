        ...
        <h2>${w.kwds['package_name']}
          <span class="dropdown show">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
              ...
              <a class="dropdown-item" href="https://bugzilla.redhat.com/buglist.cgi?component=${w.package_info['name']}&query_format=advanced&product=Fedora&bug_status=__open__"><img src = "https://admin.fedoraproject.org/community/images/16_bugs.png"/> Bugzilla </a>
              <a class="dropdown-item" href="https://retrace.fedoraproject.org/faf/problems/?component_names=${w.package_info['name']}"><img src = "${tg.url('/images/16_abrt.png')}"/> ABRT Analytics </a>
