...
<div id="container">
    <div class="container_24" id="package-details">
         <div class="grid_5" id="package-info-bar">
             ...
             <div class="owner">
                 <div><h3>POINT OF CONTACT</h3></div>
		 ...
		 <h3> In other apps </h3>
	           ...
	           <li><a class="other-app" href="https://admin.fedoraproject.org/updates/${w.package_info['name']}"><img src="${tg.url('/images/16_bodhi.png')}"/> Bodhi </a> </li>
                   ...
                   <li><a class="other-app" href="https://src.fedoraproject.org/rpms/${w.package_info['name']}"><img src = "https://apps.fedoraproject.org/img/icons/git-logo.png"/> SCM </a> </li>
