...
<h4>Quick Links for <strong>${'${package_name}'}</strong>:</h4>
                            <ul>
                               ...
                               <li><a href="https://bugzilla.redhat.com/buglist.cgi?query_format=advanced&classification=Fedora&product=Fedora&component=${'${package_name}'}&bug_status=__open__"><img src="${tg.url('/images/16_bugzilla.png')}"/><span>Go to ${'${package_name}'} <strong>bugs</strong> in Bugzilla</span><img src="${tg.url('/images/16_offsite-link.png')}"/></a></li>
