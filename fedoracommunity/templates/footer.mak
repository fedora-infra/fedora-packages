    ...
    <%def name="footer()">
        <div class="container_24">
          <div id="bottom" class="grid_24">
            <p>Found a bug?  <a href="https://github.com/fedora-infra/fedora-packages/new">File a ticket.</a>    Note:  There's some caching going on here.  If you expect something and don't see it, check back in 5 minutes.</p>
            ...
            <ul>
                ...
                <li><a href="http://fedoracommunity.fedorahosted.org">Get the source for Fedora Community Packages</a></li>
