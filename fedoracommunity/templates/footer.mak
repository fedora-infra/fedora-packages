    ...
    <%def name="footer()">
        <div class="container_24">
          <div id="bottom" class="grid_24">
            <p>Found a bug?  <a href="http://fedorahosted.org/fedoracommunity/newticket">File a ticket.</a>    Note:  There's some cacheing going on here.  If you expect something and don't see it, check back in 5 minutes.</p>
