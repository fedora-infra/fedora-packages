<div id="${id}" class="links-toolbar">
    ...
    <ul>
      <li><a href="https://admin.fedoraproject.org/updates/${package}"
             target="_blank">
             <img border="0" src="${tmpl_context.get_url('/images/16_bodhi.png')}" />
             <span>Updates</span>
          </a>
      </li>
      <li><a href="http://koji.fedoraproject.org/koji/search?terms=${package}&type=package&match=exact" target="_blank" >
              <img border=0 src="${tmpl_context.get_url('/images/16_koji.png')}" />
              <span>Builds</span>
          </a>
      </li>
      ...
      <li><a href="http://cvs.fedoraproject.org/viewvc/rpms/${package}" target="_blank" >
              <img border=0 src="${tmpl_context.get_url('/images/16_sources.png')}" />
              <span>Source</span>
          </a>
      </li>
