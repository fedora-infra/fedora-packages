...
<h4>Quick Links for <strong>@{package_name}</strong>:</h4>
                            <ul>
                               ...
                               <li><a href="https://admin.fedoraproject.org/updates/@{package_name}"><img src="${tmpl_context.get_url('/images/16_bodhi.png')}"/><span>Go to @{package_name} <strong>updates</strong> in Bodhi</span><img src="${tmpl_context.get_url(${tmpl_context.get_url('/images/16_offsite-link.png')}"/></a></li>
                               <li><a href="https://admin.fedoraproject.org/pkgdb/packages/name/@{package_name}"><img src="${tmpl_context.get_url('/images/16_pkgdb.png')}"/><span>Go to @{package_name} <strong>package info</strong> in PackageDB</span><img src="/images/16_offsite-link.png')}"/></a></li>
