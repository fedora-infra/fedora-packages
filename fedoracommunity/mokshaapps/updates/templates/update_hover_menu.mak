  <div id="menu_@{request_id}" class="menu" panel="menu_panel_@{request_id}">
    ...
    % endif
            ...
            <ul>
               <li><a href="https://admin.fedoraproject.org/updates/@{title}"><img src="${tmpl_context.get_url('/images/16_bodhi.png')}"/><span>Go to the @{title} <strong>update</strong> in Bodhi</span><img src="${tmpl_context.get_url('/images/16_offsite-link.png')}"/></a></li>
               ...
               <li><a href="https://admin.fedoraproject.org/pkgdb/packages/name/@{name}"><img src="${tmpl_context.get_url('/images/16_pkgdb.png')}"/><span>Go to @{name} <strong>package info</strong> in PackageDB</span><img src="${tmpl_context.get_url('/images/16_offsite-link.png')}"/></a></li>
