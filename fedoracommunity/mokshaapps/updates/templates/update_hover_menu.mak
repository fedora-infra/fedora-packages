  <div id="menu_@{request_id}" class="menu" panel="menu_panel_@{request_id}">
    ...
    % endif
            ...
            <ul>
               <li><a href="https://admin.fedoraproject.org/updates/@{title}"><img src="${tmpl_context.get_url('/images/16_bodhi.png')}"/><span>Go to this <strong>update</strong> in Bodhi</span><img src="${tmpl_context.get_url('/images/16_offsite-link.png')}"/></a></li>
